...
#SBATCH --gres=gpu:4
#SBATCH --array=0-99
#SBATCH --output=benchmark_runs_20251206_190739/slurm_%A_%a.out
#SBATCH --error=benchmark_runs_20251206_190739/slurm_%A_%a.err
...
MAIN_DIR="benchmark_runs_20251206_190739"
TASK_LIST="$MAIN_DIR/task_list.txt"
